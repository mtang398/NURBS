#include "BezierCurve.h" // Assuming this is the header file where BezierCurve is defined
#include <Eigen/Dense> // For the Eigen::MatrixXd
#include <igl/opengl/glfw/Viewer.h> // For igl::opengl::glfw::Viewer
